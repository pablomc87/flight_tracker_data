...
with DAG(
    ...
    average_flight_distance_per_continent_task = PostgresOperator(
        task_id="average_flight_distance_per_continent",
        sql="sql/average_flight_distance_per_continent.sql",
        postgres_conn_id="postgres_conn",
    )

    trigger_another_dag_task >> average_flight_distance_per_continent_task
